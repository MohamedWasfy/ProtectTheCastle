...
int main()
{
	...
	//Declrae some enemies 
	enemy e1;
	e1.ID=0;	e1.Region=1;	e1.Distance=37;		e1.Health=5; e1.Type=2;

	enemy e2;
	e2.ID=1;	e2.Region=4;	e2.Distance=17;		e2.Health=7; e2.Type=1;

	enemy e3;
	e3.ID=2;	e3.Region=2;	e3.Distance=30;		e3.Health=8; e3.Type=3;

	enemy e4;
	e4.ID=3;	e4.Region=1;	e4.Distance=11;		e4.Health=9; e4.Type=3;

	enemy e5;
	e5.ID=3;	e5.Region=3;	e5.Distance=19;		e5.Health=9; e5.Type=3;

	enemy e6;
	e6.ID=3;	e6.Region=3;	e6.Distance=30;		e6.Health=9; e6.Type=2;
